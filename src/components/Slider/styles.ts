...
const getBaseThumbStyles = ({ imageKey, disabled }: StyledInputProps) => `
  -webkit-appearance: none;
  background-image: url('https://cloudfront.ghostnft.io/images/ghostboy-32-${imageKey}.svg');
  ...
  &:hover {
    transform: ${disabled ? "scale(1) translate(-12px, 2px)" : "scale(1.1) translate(-13px, 1px)"};
  }
`;
