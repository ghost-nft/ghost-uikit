...
var BnbPrice = function (_a) {
    ...
    return BnbPriceUsd ? (React__default.createElement(PriceLink, { href: "https://ghostnft.io/swap", target: "_blank" },
        React__default.createElement(Icon$21, { width: "24px", mr: "8px" }),
        ...
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            ...
            React__default.createElement(StyledToolsContainer, { order: [1, null, 3], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                ...
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    React__default.createElement(Button, { as: "a", href: "https://ghostnft.io/nft", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$27, { color: lightColors.backgroundAlt }) }, buyNFTLabel))))));
};
