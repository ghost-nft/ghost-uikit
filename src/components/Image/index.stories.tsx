...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://ghostnft.io/images/tokens/${token.symbol}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://ghostnft.io/images/tokens/${token.symbol}.svg`;
        const secondarySrc = `https://ghostnft.io/images/tokens/${tokens[randomTokenIndex].symbol}.svg`;
